...
// Login Pengunjung / Pencari Kost (Guard: web)
...
// Route Logout Universal (Bisa diakses dari guard mana saja)
Route::post('/logout', [AuthController::class, 'logout'])->name('logout');


// ============================================================
// DASHBOARD & FITUR (PROTECTED BERDASARKAN GUARD SPESIFIK)
// ============================================================

// 1. PENCARI KOST (Hanya yang login menggunakan tabel tbl_user / web)
...
// 2. MITRA KOST (Hanya yang login menggunakan tabel mitras)
Route::middleware(['auth:mitra', PreventBackHistory::class])->group(function () {
...
// 3. SUPER ADMIN (Hanya yang login menggunakan tabel super_admin)
