...
<head>
    ...
    <title>Registrasi Mitra - SIKOSUB</title>
    ...
    <div class="right-side">
        <div class="login-container">
            <div class="login-header">
                ...
                <h3>Daftarkan Diri Anda Sebagai Pemilik Kost</h3>
            </div>

            <form action="{{ route('mitra.register.submit') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn-submit">Daftar Sebagai Mitra</button>
            </form>

            <div class="auth-footer">
                Sudah punya akun mitra? <a href="{{ route('mitra.login') }}">Login di sini</a>
            </div>
        </div>
    </div>
